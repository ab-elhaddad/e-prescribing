        ...
        <div className="flex justify-around my-12 py-4 backdrop-blur-md bg-white/30 rounded-2xl hover:-translate-y-1 hover:shadow-sm transition duration-500 ease-in-out">
          <div>
            ...
            <p className="w-inherit p-3" style={{ width: "50ch" }}>
              ...
              and have been recognized by many organizations. They are the best
              in the world. We have variety of doctors who are specialized in
              different fields. We have doctors who are specialized in heart,
              brain, kidney, liver, etc. We have doctors who are specialized in
              different diseases. We have doctors who are specialized in
        ...
        <div className="flex justify-around mt-40 my-12 py-4 backdrop-blur-md bg-white/30 rounded-2xl hover:-translate-y-1 hover:shadow-sm transition duration-500 ease-in-out">
          ...
          <div>
            ...
            <p className="w-inherit p-3" style={{ width: "50ch" }}>
              ...
              E-Prescribing has won the best medical e-service in Egypt in 2022,
              2023 and 2024. We have a team of doctors who are specialized in a
              variety of fields. We have a team of doctors who are specialized
              in heart, brain, kidney, liver, etc.
            </p>
          </div>
        </div>
      </div>
